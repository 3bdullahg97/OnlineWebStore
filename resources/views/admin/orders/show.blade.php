...
@section('admin-content')
    <nav class="justify-start items-center text-gray text-sm m-20 mb-0">
        <span><a href="{{ route('admin') }}">Admin Panel</a> / <a href="{{ route('admin.orders') }}">Orders</a> /
            <a class="font-bold" href="{{ route('admin.orders.show', $order->id) }}">Order #{{ $order->id }}</a></span>
    </nav>
